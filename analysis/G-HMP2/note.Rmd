...
pdf(file="HMP2_pcoa_metrics.pdf", width=13.3, height=10)
pall
dev.off()
```
...
p.ent <- ggpubr::ggarrange(
  p.JSD.ent + ggtitle("jensen-shannon bacteroides/prevotella"), 
  p.CAN.ent + ggtitle("canberra bacteroides/prevotella"), 
  p.HEL.ent + ggtitle("hellinger bacteroides/prevotella"),
  p.BRA.ent + ggtitle("bray-curtis bacteroides/prevotella"),
  p.AIT.ent + ggtitle("aitchison bacteroides/prevotella"), 
  ncol = 5, legend = "none"
)
```
...
p.sub <- ggpubr::ggarrange(
  p.JSD.sub + ggtitle("jensen-shannon subjects"), 
  p.CAN.sub + ggtitle("canberra subjects"), 
  p.HEL.sub + ggtitle("hellinger subjects"),
  p.BRA.sub + ggtitle("bray-curtis subjects"),
  p.AIT.sub + ggtitle("aitchison subjects"), 
...
```{r}
png("../Supplementary/HMP2_pcoa_more_metrics.png", width = 6000, height = 2400, res = 300)
pall
dev.off()
```
